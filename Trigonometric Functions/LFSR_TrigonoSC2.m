...
if N == 256
    ...
    for i = 1:1:255 % (2^8-1) Cycle
        insertion = xor(xor(xor(seed(8), seed(6)), seed(5)), seed(1));
...
if N == 512
    ...
    for i = 1:1:511 % (2^9-1) Cycle
        ...
        insertion = xor(xor(xor(seed(9), seed(5)), seed(3)), seed(2));
...
if N == 1024
    ...
    for i = 1:1:1023 % (2^10-1) Cycle
        insertion = xor(xor(xor(seed(10), seed(8)), seed(5)), seed(4)); %tap
